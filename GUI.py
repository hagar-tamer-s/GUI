...
label2.pack(padx=30 ,pady=30 ,ipady=5 ,expand=True ,anchor="w")

entry = Entry(root ,width=50)
entry.pack(ipady=5 ,padx=30 ,pady=10 ,fill=X ,expand=True ,anchor="center")
